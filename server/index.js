...
app.post('/api/recover-password', async (req, res) => {
    console.log('[EMERGENCIA] Petición de recuperación bloqueada para evitar spam.');
    return res.json({ success: true, message: 'Servicio de recuperación temporalmente en mantenimiento de seguridad.' });
});
